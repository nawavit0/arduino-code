...
Adafruit_MQTT_Subscribe esp8266_1_sub = Adafruit_MQTT_Subscribe(&mqtt, MQTT_USERNAME "/sub/esp8266_1"); 
...
void loop() {  
  ...
  while ((subscription = mqtt.readSubscription())) {
    if (subscription == &esp8266_1_sub) { 
      char *message = (char *)esp8266_1_sub.lastread;
      Serial.print(F("Got: ")); 
      Serial.println(message); 
      if (strncmp(message, "a", 1) == 0) { 
          img = "a.bmp";
      } else if (strncmp(message, "b", 1) == 0) {
          img = "b.bmp";
