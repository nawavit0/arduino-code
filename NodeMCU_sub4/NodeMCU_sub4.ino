...
Adafruit_MQTT_Subscribe esp8266_4_sub = Adafruit_MQTT_Subscribe(&mqtt, MQTT_USERNAME "/sub/esp8266_4"); 
...
void loop() {  
  ...
  while ((subscription = mqtt.readSubscription())) {
    if (subscription == &esp8266_4_sub) { 
      char *message = (char *)esp8266_4_sub.lastread;
//      Serial.print(F("Got: ")); 
