...
constexpr uint8_t RST_2_PIN = 5;         // Configurable, see typical pin layout above
constexpr uint8_t RST_3_PIN = 6;
constexpr uint8_t RST_4_PIN = 7;
constexpr uint8_t RST_5_PIN = 8;
constexpr uint8_t RST_6_PIN = 9;  

constexpr uint8_t SS_1_PIN = 41;         // Configurable, see typical pin layout above
constexpr uint8_t SS_2_PIN = 42; 
constexpr uint8_t SS_3_PIN = 43; 
constexpr uint8_t SS_4_PIN = 44; 
constexpr uint8_t SS_5_PIN = 45; 
constexpr uint8_t SS_6_PIN = 46; 
